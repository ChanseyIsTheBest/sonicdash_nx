...
/* Real thread suspension, used by the GC stop-the-world bridge (sd_gc.c). */
int  diag_pause_pthread_ctx(void *target_pthread, ThreadContext *ctx); /* 1 ctx, 2 no ctx, 0 no */
